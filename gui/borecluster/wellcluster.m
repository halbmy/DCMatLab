function varargout = wellcluster(varargin)
% WELLCLUSTER M-file for wellcluster.fig
%      WELLCLUSTER, by itself, creates a new WELLCLUSTER or raises the existing
%      singleton*.
%
%      H = WELLCLUSTER returns the handle to a new WELLCLUSTER or the handle to
%      the existing singleton*.
%
%      WELLCLUSTER('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WELLCLUSTER.M with the given input arguments.
%
%      WELLCLUSTER('Property','Value',...) creates a new WELLCLUSTER or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wellcluster_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wellcluster_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wellcluster
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @wellcluster_OpeningFcn, ...
                   'gui_OutputFcn',  @wellcluster_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wellcluster is made visible.
function wellcluster_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wellcluster (see VARARGIN)

% Choose default command line output for wellcluster
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes wellcluster wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = wellcluster_OutputFcn(hObject, eventdata, handles) 
