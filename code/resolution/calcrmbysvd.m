function [Rm,RM,RD,s,lambda]=calcrmbysvd(S,N,dR)

% CALCRMBYSVD - Get Model Resolution from SVD
% [Rm,RM,RD,s] = calcrmbysvd(S,N,lambda)  OR
% [Rm,RM,RD,s] = calcrmbysvd(S,N,dR)
