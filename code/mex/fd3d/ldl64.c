 ...
 */
#define LDL_long long

void LDL_symbolic
(
    LDL_int n,		/* A and L are n-by-n, where n >= 0 */
    LDL_long Ap [ ],	/* input of size n+1, not modified */
    LDL_long Ai [ ],	/* input of size nz=Ap[n], not modified */
    LDL_long Lp [ ],	/* output of size n+1, not defined on input */
...
(
    ...
    LDL_long Lp [ ],	/* input of size n+1, not modified */
    LDL_int Parent [ ],	/* input of size n, not modified */
    LDL_int Lnz [ ],	/* output of size n, not defn. on input */
    LDL_long Li [ ],	/* output of size lnz=Lp[n], not defined on input */
...
(
    ...
    LDL_long Lp [ ],	/* input of size n+1, not modified */
    LDL_long Li [ ],	/* input of size lnz=Lp[n], not modified */
