...
if (zeile(1)=='#')&&(any(strfind(lz,'a'))||...
    ...
    ia=0;ib=0;im=0;in=0;ir=0;ierr=0;iip=0;ii=0;iu=0;ik=0;it=0;ig=0;is=0;
...
%         end
    ...
    if (zeile(1)=='#')&&(any(strfind(lz,'a'))||...
            any(strfind(lz,'b'))||any(strfind(lz,'s'))),
        ia=0;ib=0;im=0;in=0;ir=0;ierr=0;iip=0;ii=0;iu=0;ik=0;it=0;ig=0;is=0;ifr=0;
        emul=1;imul=1;umul=1;tmul=1;irho=0;isp=0;
        zeile(1)='';zeile=destrip(zeile);i=0;formstr='';
        while ~isempty(zeile),
            i=i+1;utok='';
...
%     message('Found nonpositive errors. Discarding error values.');
%     N=rmfield(N,'err');
% end
